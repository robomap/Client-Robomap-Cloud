...
import temp.model.Song;
import temp.model.TimeManager;
import temp.model.User;
import temp.view.PlayListButton;
...
public class MainView extends JFrame {	
	...
	public void MusicaWest(){
		JLabel jlabMusica = new JLabel("     TU M�SICA");
	...
	public void AlbumesWest(){
		 ...
		 JLabel jlAlbumes = new JLabel("                �lbumes");
	...
	public void registreTableArchivos(MainController mainController){
		...
		JMenuItem newPlaylist =	new JMenuItem("A�adir nueva Playlist");
		...
		playlist =	new JMenu();
		playlist.setText("A�adir a la playlist");
